...
export const stateSources: StateSource[] = [
  ...
  // ─── STATIC HTML (easy — table or list on page) ───────────
  {
    ...
    enabled: false,
    notes: "No public sponsor list published. PIRP page is informational only. Sponsors must be added manually.",
  },
  {
    stateCode: "NV",
    stateName: "Nevada",
  ...
  // ─── PLAYWRIGHT (need browser interaction) ────────────────
  {
    ...
    enabled: false,
    notes: "Class schedule search, not a school directory. Requires zip + date. Cannot list all schools without iterating.",
  },
  {
    stateCode: "VA",
    stateName: "Virginia",
