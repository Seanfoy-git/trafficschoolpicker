...
export const stateSources: StateSource[] = [
  ...
  // ─── STATIC HTML (easy — table or list on page) ───────────
  {
    ...
    enabled: true,
    notes: "PIRP provider table. Drupal CMS, standard <table>.",
  },
  {
    stateCode: "NV",
    stateName: "Nevada",
  ...
  // ─── PLAYWRIGHT (need browser interaction) ────────────────
  {
    ...
    enabled: true,
    notes: "ASP.NET DNN module. AJAX/ViewState. Needs Playwright.",
  },
  {
    stateCode: "VA",
    stateName: "Virginia",
    source: "VA DMV",
    method: "playwright",
    url: "https://www.dmv.virginia.gov/licenses-ids/improvement/clinics-schools",
    enabled: true,
    notes: "Drupal 10 faceted search. 200+ online clinics. Paginated.",
    playwright: {
      steps: ["Filter by 'Online Clinic'", "Paginate through results"],
    },
  },
  {
    stateCode: "OH",
    ...
    enabled: true,
    notes: "DataTables search. Filter by Program Type.",
  },
  {
    stateCode: "GA",
    stateName: "Georgia",
    ...
    enabled: true,
    notes: "ASP.NET server-rendered page.",
  },
  {
    stateCode: "TN",
    stateName: "Tennessee",
    source: "TN Safety",
    method: "playwright",
    url: "https://tedi.safety.tn.gov/",
    enabled: true,
    notes: "TEDI system. Form-based search with POST. ASP.NET.",
  },
  {
    stateCode: "OR",
    stateName: "Oregon",
    ...
    enabled: true,
    notes: "SharePoint DataTables. Searchable, sortable.",
  },
  {
    stateCode: "SC",
  ...
  // ─── PDF SOURCES (parse separately) ───────────────────────
  {
    ...
    enabled: true,
    notes: "Web app version. Also has PDF at ilsos.gov.",
  },
  {
    stateCode: "OK",
    stateName: "Oklahoma",
