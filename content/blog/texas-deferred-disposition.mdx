...
<QuickAnswer>
Texas deferred disposition is a court-ordered agreement where you plead no contest, the court defers judgment and sets conditions (often a 6-hour TDLR-approved defensive driving course within 90 days), and the ticket is then dismissed entirely from your public record. It overlaps with the separate driving safety course dismissal (Code of Criminal Procedure art. 45A.352), the course-only route many drivers use; both end in dismissal, and this guide explains how each works.
</QuickAnswer>
...
**Deferred disposition vs. the driving safety course — are they the same?**
Not exactly. This guide describes the **driving safety course dismissal** (Art. 45A.352), the course-based mechanism most Texas drivers use for a routine ticket. **Deferred disposition** (Art. 45A.353) is a related but separate probationary option a court may offer, which doesn't necessarily require a course. Both end in a dismissal; ask your court which applies to your citation.

## Sources

- **Tex. Code Crim. Proc. Art. 45A.352 & 45A.354** — driving safety course dismissal and the 90-day completion window (the mechanism this guide describes). Texas recodified the former Art. 45.0511 into Chapter 45A effective January 1, 2025. ([statutes.capitol.texas.gov](https://statutes.capitol.texas.gov/Docs/CR/htm/CR.45A.htm))
- **Tex. Code Crim. Proc. Art. 45A.353** — deferred disposition (the distinct probationary mechanism).
...
*General information, not legal advice — confirm the current rules and deadlines with the court printed on your citation.*
